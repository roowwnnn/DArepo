    ...
    <div class="container-fluid p-3">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
          ...
          <a class="nav-item" href="viewprofile.php"><button class="btn custom-btn viewProfileBtn"><img src="imgs/<?php echo $userpfp?>"
                style=" height: 50px; width: 50px;"></button></a>
          <a class="nav-item" href="login.php"><button class="btn custom-btn logoutBtn"><b>Log Out</b></button></a>
