...
<div class="row p-5" style="text-align: center;">
    <div class="container-fluid profileContainer">
      <div class="row p-3" style="border-radius: 30px 30px 0 0;" >
        ...
        <div class="col-12 col-sm-7 col-md-10 col-lg-10 col-xl-10" >  
            <div class="container nameContainer" style="text-align: left;">
              <p class="name"><?php echo $user['firstName']  ?> <?php echo $user['lastName'] ?></p>
      ...
      <div class="row mt-5" >
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 p-5">
          <div class="container" style="text-align: center;">
            <p class="firstName"><b>First Name:</b>  &nbsp;<?php echo $user['firstName'] ?></p>
          </div>
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 p-5" >  
            <div class="container" style="text-align: center;">
              <p class="lastName"><b>Last Name:</b> &nbsp;<?php echo $user['lastName'] ?></p>
            </div>
        </div>
      </div>
      ...
      <div class="row my-5" >
        ...
        <div class="container deleteBtnContainer" style="text-align: center;">
        ...
        <div class="container deleteBtnContainer">
          <a href="updateprofile.php"><button type="button" class="btn custom-btn btn-lg updateButton"><b>EDIT ACCOUNT</b></button></a>
        </div>
        </div>
      </div>
      </form>
