...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2024 at 10:42 AM
...
INSERT INTO `users` (`userID`, `messageID`, `userName`, `userpfp`, `password`, `isDeleted`) VALUES
(1, 0, 'moraxnomora', 'zhonglipfp.png', 'iloveraiden', 'no'),
(2, 0, 'raidencantcook', 'raidenpfp.png', 'eternity', 'no'),
(3, 0, 'changli_baby', 'changlipfp.png', 'ganda', 'no'),
(4, 0, 'haseoTOD', 'haseopfp.png', '5/>f!_SE', 'no'),
(5, NULL, 'harry_pota', 'nopfp.png', 'password1234', 'yes');
